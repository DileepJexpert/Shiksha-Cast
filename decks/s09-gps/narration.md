...
दोस्तों, ज़रा सोचो — तुम किसी नई जगह पर हो, फ़ोन निकाला, map खोला, और एक नीला dot ठीक तुम्हारे ऊपर! फ़ोन को कैसे पता चला कि तुम पूरी पृथ्वी पर ठीक किस जगह खड़े हो? इसके पीछे है space में घूमते satellites की एक पूरी फ़ौज और गणित का ज़बरदस्त जादू! आज Katixo KhojLab पर हम समझेंगे कि GPS आख़िर काम कैसे करता है — satellites, signals, और एक trick जिसका नाम है trilateration. चलो शुरू करते हैं!
